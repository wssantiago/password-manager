...
class Data:
    ...
    def __init__(self, path):
        self.path = resources.resource_path(path + 'pwm.db')
        self.db = None
        self.cursor = None

        publicFile = open(resources.resource_path(path + "public.txt"), "r")
        ...
        privateFile = open(resources.resource_path(path + "private.txt"), "r")
